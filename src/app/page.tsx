    ...
    <div className="animate-fadeUp space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <StatCard
          ...
          value={
            latestPayroll
              ? formatCurrency(Number(latestPayroll.totalNet))
              : "—"
          }
          icon={<Wallet size={16} />}
        ...
        <StatCard
          ...
          value={
            latestPayroll
              ? new Date(latestPayroll.createdAt).toLocaleDateString("en-IN")
              : "—"
          }
          icon={<Send size={16} />}
      ...
      <div className="glass-card rounded-2xl p-6 shadow-card">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          ...
          <a
            href="/payroll"
            className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 font-medium hover:bg-white/10 transition-colors"
          >
            Generate Payroll
          </a>
